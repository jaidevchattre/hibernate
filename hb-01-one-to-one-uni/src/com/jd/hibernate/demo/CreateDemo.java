...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		//create objects
		Instructor instructor=new Instructor("Jai","Chattre","jaidevchattre@gmail.com");
		
		InstructorDetail instructorDetail= new InstructorDetail("https://www.jd.com/youtube2", "Cricket2");
